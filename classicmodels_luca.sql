...
-- Host: 127.0.0.1
-- Creato il: Feb 02, 2021 alle 17:50
...
--
CREATE DATABASE IF NOT EXISTS `classicmodels_luca` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `classicmodels_luca`;
...
(103, 'Atelier graphique', 'Schmitt', 'Carine ', '40.32.2555', '54, rue Royale', NULL, 'Lyon', NULL, '44000', 'France', 1370, '21000.00'),
(112, 'Signal Gift Stores', 'Quenn', 'Jean', '7025551838', '8489 Strong St.', NULL, 'Las Vegas', 'NV', '83030', 'USA', 1166, '71800.00'),
...
(1076, 'PIRELLI', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 1002, 'VP Marketing'),
...
(9988, 'GURRINI', 'luciano', '654', '654', '2', 1102, 'Sales Rep');

--
-- Trigger `employees`
--
DELIMITER $$
CREATE TRIGGER `employees_AFTER_UPDATE` BEFORE UPDATE ON `employees` FOR EACH ROW BEGIN

if old.lastName != new.lastname THEN 
	set new.lastname=ucase(new.lastname);
end if;
...
(1, 'Test MySQL Event 2', '2020-02-17 18:32:34'),
(2, 'Test MySQL recurring Event', '2020-02-17 18:32:37'),
(3, 'Test MySQL recurring Event', '2020-02-17 18:32:42'),
(4, 'Test MySQL recurring Event', '2020-02-17 18:32:47'),
(5, 'Test MySQL recurring Event', '2020-02-17 18:32:52'),
(6, 'Test MySQL recurring Event', '2020-02-17 18:32:57'),
(7, 'Test MySQL recurring Event', '2020-02-17 18:33:02'),
(8, 'Test MySQL recurring Event', '2020-02-17 18:33:05'),
(9, 'Test MySQL recurring Event', '2020-02-17 18:33:07'),
(10, 'Test MySQL recurring Event', '2020-02-17 18:33:12'),
(11, 'Test MySQL recurring Event', '2020-02-17 18:33:17'),
(12, 'Test MySQL recurring Event', '2020-02-17 18:33:22'),
(13, 'Test MySQL recurring Event', '2020-02-17 18:33:27'),
(14, 'Test MySQL recurring Event', '2020-02-17 18:33:32'),
(15, 'Test MySQL recurring Event', '2020-02-17 18:33:37'),
(16, 'Test MySQL recurring Event', '2020-02-17 18:33:42'),
(17, 'Test MySQL recurring Event', '2020-02-17 18:33:47'),
(18, 'Test MySQL recurring Event', '2020-02-17 18:33:52'),
(19, 'Test MySQL recurring Event', '2020-02-17 18:33:57'),
(20, 'Test MySQL recurring Event', '2020-02-17 18:34:02'),
(21, 'Test MySQL recurring Event', '2020-02-17 18:34:05'),
(22, 'Test MySQL recurring Event', '2020-02-17 18:34:07'),
(23, 'Test MySQL recurring Event', '2020-02-17 18:34:12'),
(24, 'Test MySQL recurring Event', '2020-02-17 18:34:17'),
(25, 'Test MySQL recurring Event', '2020-02-17 18:34:22'),
(26, 'Test MySQL recurring Event', '2020-02-17 18:34:27'),
(27, 'Test MySQL recurring Event', '2020-02-17 18:34:32'),
(28, 'Test MySQL recurring Event', '2020-02-17 18:34:37'),
(29, 'Test MySQL recurring Event', '2020-02-17 18:34:42'),
(30, 'Test MySQL recurring Event', '2020-02-17 18:34:47'),
(31, 'Test MySQL recurring Event', '2020-02-17 18:34:52'),
(32, 'Test MySQL recurring Event', '2020-02-17 18:34:57'),
(33, 'Test MySQL recurring Event', '2020-02-17 18:35:02'),
(34, 'Test MySQL recurring Event', '2020-02-17 18:35:05'),
(35, 'Test MySQL recurring Event', '2020-02-17 18:35:07'),
(36, 'Test MySQL recurring Event', '2020-02-17 18:35:12'),
(37, 'Test MySQL recurring Event', '2020-02-17 18:35:17'),
(38, 'Test MySQL recurring Event', '2020-02-17 18:35:22'),
(39, 'Test MySQL recurring Event', '2020-02-17 18:35:27'),
(40, 'Test MySQL recurring Event', '2020-02-17 18:35:32'),
(41, 'Test MySQL recurring Event', '2020-02-17 18:35:37'),
(42, 'Test MySQL recurring Event', '2020-02-17 18:35:42'),
(43, 'Test MySQL recurring Event', '2020-02-17 18:35:47'),
(44, 'Test MySQL recurring Event', '2020-02-17 18:35:52'),
(45, 'Test MySQL recurring Event', '2020-02-17 18:35:57'),
(46, 'Test MySQL recurring Event', '2020-02-17 18:36:02'),
(47, 'Test MySQL recurring Event', '2020-02-17 18:36:05'),
(48, 'Test MySQL recurring Event', '2020-02-17 18:36:07'),
(49, 'Test MySQL recurring Event', '2020-02-17 18:36:12'),
(50, 'Test MySQL recurring Event', '2020-02-17 18:36:17'),
(51, 'Test MySQL recurring Event', '2020-02-17 18:36:22'),
(52, 'Test MySQL recurring Event', '2020-02-17 18:36:27'),
(53, 'Test MySQL recurring Event', '2020-02-17 18:36:32'),
(54, 'Test MySQL recurring Event', '2020-02-17 18:36:37'),
(55, 'Test MySQL recurring Event', '2020-02-17 18:36:42'),
(56, 'Test MySQL recurring Event', '2020-02-17 18:36:47'),
(57, 'Test MySQL recurring Event', '2020-02-17 18:36:52'),
(58, 'Test MySQL recurring Event', '2020-02-17 18:36:57'),
(59, 'Test MySQL recurring Event', '2020-02-17 18:37:02'),
(60, 'Test MySQL recurring Event', '2020-02-17 18:37:05'),
(61, 'Test MySQL recurring Event', '2020-02-17 18:37:07'),
(62, 'Test MySQL recurring Event', '2020-02-17 18:37:12'),
(63, 'Test MySQL recurring Event', '2020-02-17 18:37:17'),
(64, 'Test MySQL recurring Event', '2020-02-17 18:37:22'),
(65, 'Test MySQL recurring Event', '2020-02-17 18:37:27'),
(66, 'Test MySQL recurring Event', '2020-02-17 18:37:32'),
(67, 'Test MySQL recurring Event', '2020-02-17 18:37:37'),
(68, 'Test MySQL recurring Event', '2020-02-17 18:37:42'),
(69, 'Test MySQL recurring Event', '2020-02-17 18:37:47'),
(70, 'Test MySQL recurring Event', '2020-02-17 18:37:52'),
(71, 'Test MySQL recurring Event', '2020-02-17 18:37:57'),
(72, 'Test MySQL recurring Event', '2020-02-17 18:38:02'),
(73, 'Test MySQL recurring Event', '2020-02-17 18:38:05'),
(74, 'Test MySQL recurring Event', '2020-02-17 18:38:07'),
(75, 'Test MySQL recurring Event', '2020-02-17 18:38:12'),
(76, 'Test MySQL recurring Event', '2020-02-17 18:38:17'),
(77, 'Test MySQL recurring Event', '2020-02-17 18:38:22'),
(78, 'Test MySQL recurring Event', '2020-02-17 18:38:27'),
(79, 'Test MySQL recurring Event', '2020-02-17 18:38:32'),
(80, 'Test MySQL recurring Event', '2020-02-17 18:38:37'),
(81, 'Test MySQL recurring Event', '2020-02-17 18:38:42'),
(82, 'Test MySQL recurring Event', '2020-02-17 18:38:47'),
(83, 'Test MySQL recurring Event', '2020-02-17 18:38:52'),
(84, 'Test MySQL recurring Event', '2020-02-17 18:38:57'),
(85, 'Test MySQL recurring Event', '2020-02-17 18:39:02'),
(86, 'Test MySQL recurring Event', '2020-02-17 18:39:05'),
(87, 'Test MySQL recurring Event', '2020-02-17 18:39:07'),
(88, 'Test MySQL recurring Event', '2020-02-17 18:39:12'),
(89, 'Test MySQL recurring Event', '2020-02-17 18:39:17'),
(90, 'Test MySQL recurring Event', '2020-02-17 18:39:22'),
(91, 'Test MySQL recurring Event', '2020-02-17 18:39:27'),
(92, 'Test MySQL recurring Event', '2020-02-17 18:39:32'),
(93, 'Test MySQL recurring Event', '2020-02-17 18:39:37'),
(94, 'Test MySQL recurring Event', '2020-02-17 18:39:42'),
(95, 'Test MySQL recurring Event', '2020-02-17 18:39:47'),
(96, 'Test MySQL recurring Event', '2020-02-17 18:39:52'),
(97, 'Test MySQL recurring Event', '2020-02-17 18:39:57'),
(98, 'Test MySQL recurring Event', '2020-02-17 18:40:02'),
(99, 'Test MySQL recurring Event', '2020-02-17 18:40:05'),
(100, 'Test MySQL recurring Event', '2020-02-17 18:40:07'),
(101, 'Test MySQL recurring Event', '2020-02-17 18:40:12'),
(102, 'Test MySQL recurring Event', '2020-02-17 18:40:17'),
(103, 'Test MySQL recurring Event', '2020-02-17 18:40:22'),
(104, 'Test MySQL recurring Event', '2020-02-17 18:40:27'),
(105, 'Test MySQL recurring Event', '2020-02-17 18:40:32'),
(106, 'Test MySQL recurring Event', '2020-02-17 18:40:37'),
(107, 'Test MySQL recurring Event', '2020-02-17 18:40:42'),
(108, 'Test MySQL recurring Event', '2020-02-17 18:40:47'),
(109, 'Test MySQL recurring Event', '2020-02-17 18:40:52'),
(110, 'Test MySQL recurring Event', '2020-02-17 18:40:57'),
(111, 'Test MySQL recurring Event', '2020-02-17 18:41:02'),
(112, 'Test MySQL recurring Event', '2020-02-17 18:41:05'),
(113, 'Test MySQL recurring Event', '2020-02-17 18:41:07'),
(114, 'Test MySQL recurring Event', '2020-02-17 18:41:12'),
(115, 'Test MySQL recurring Event', '2020-02-17 18:41:17'),
(116, 'Test MySQL recurring Event', '2020-02-17 18:41:22'),
(117, 'Test MySQL recurring Event', '2020-02-17 18:41:27'),
(118, 'Test MySQL recurring Event', '2020-02-17 18:41:32'),
(119, 'Test MySQL recurring Event', '2020-02-17 18:41:37'),
(120, 'Test MySQL recurring Event', '2020-02-17 18:41:42'),
(121, 'Test MySQL recurring Event', '2020-02-17 18:41:47'),
(122, 'Test MySQL recurring Event', '2020-02-17 18:41:52'),
(123, 'Test MySQL recurring Event', '2020-02-17 18:41:57'),
(124, 'Test MySQL recurring Event', '2020-02-17 18:42:02'),
(125, 'Test MySQL recurring Event', '2020-02-17 18:42:05'),
(126, 'Test MySQL recurring Event', '2020-02-17 18:42:07'),
(127, 'Test MySQL recurring Event', '2020-02-17 18:42:12'),
(128, 'Test MySQL recurring Event', '2020-02-17 18:42:17'),
(129, 'Test MySQL recurring Event', '2020-02-17 18:42:22'),
(130, 'Test MySQL recurring Event', '2020-02-17 18:42:27'),
(131, 'Test MySQL recurring Event', '2020-02-17 18:42:32'),
(132, 'Test MySQL recurring Event', '2020-02-17 18:42:37'),
(133, 'Test MySQL recurring Event', '2020-02-17 18:42:42'),
(134, 'Test MySQL recurring Event', '2020-02-17 18:42:47'),
(135, 'Test MySQL recurring Event', '2020-02-17 18:42:52'),
(136, 'Test MySQL recurring Event', '2020-02-17 18:42:57'),
(137, 'Test MySQL recurring Event', '2020-02-17 18:43:02'),
(138, 'Test MySQL recurring Event', '2020-02-17 18:43:05'),
(139, 'Test MySQL recurring Event', '2020-02-17 18:43:07'),
(140, 'Test MySQL recurring Event', '2020-02-17 18:43:12'),
(141, 'Test MySQL recurring Event', '2020-02-17 18:43:17'),
(142, 'Test MySQL recurring Event', '2020-02-17 18:43:22'),
(143, 'Test MySQL recurring Event', '2020-02-17 18:43:27'),
(144, 'Test MySQL recurring Event', '2020-02-17 18:43:32'),
(145, 'Test MySQL recurring Event', '2020-02-17 18:43:37'),
(146, 'Test MySQL recurring Event', '2020-02-17 18:43:42'),
(147, 'Test MySQL recurring Event', '2020-02-17 18:43:47'),
(148, 'Test MySQL recurring Event', '2020-02-17 18:43:52'),
(149, 'Test MySQL recurring Event', '2020-02-17 18:43:57'),
(150, 'Test MySQL recurring Event', '2020-02-17 18:44:02'),
(151, 'Test MySQL recurring Event', '2020-02-17 18:44:05'),
(152, 'Test MySQL recurring Event', '2020-02-17 18:44:07'),
(153, 'Test MySQL recurring Event', '2020-02-17 18:44:12'),
(154, 'Test MySQL recurring Event', '2020-02-17 18:44:17'),
(155, 'Test MySQL recurring Event', '2020-02-17 18:44:22'),
(156, 'Test MySQL recurring Event', '2020-02-17 18:44:27'),
(157, 'Test MySQL recurring Event', '2020-02-17 18:44:32'),
(158, 'Test MySQL recurring Event', '2020-02-17 18:44:37'),
(159, 'Test MySQL recurring Event', '2020-02-17 18:44:42'),
(160, 'Test MySQL recurring Event', '2020-02-17 18:44:47'),
(161, 'Test MySQL recurring Event', '2020-02-17 18:44:52'),
(162, 'Test MySQL recurring Event', '2020-02-17 18:44:57'),
(163, 'Test MySQL recurring Event', '2020-02-17 18:45:02'),
(164, 'Test MySQL recurring Event', '2020-02-17 18:45:05'),
(165, 'Test MySQL recurring Event', '2020-02-17 18:45:07'),
(166, 'Test MySQL recurring Event', '2020-02-17 18:45:12'),
(167, 'Test MySQL recurring Event', '2020-02-17 18:45:17'),
(168, 'Test MySQL recurring Event', '2020-02-17 18:45:22'),
(169, 'Test MySQL recurring Event', '2020-02-17 18:45:27'),
(170, 'Test MySQL recurring Event', '2020-02-17 18:45:32'),
(171, 'Test MySQL recurring Event', '2020-02-17 18:45:37'),
(172, 'Test MySQL recurring Event', '2020-02-17 18:45:42'),
(173, 'Test MySQL recurring Event', '2020-02-17 18:45:47'),
(174, 'Test MySQL recurring Event', '2020-02-17 18:45:52'),
(175, 'Test MySQL recurring Event', '2020-02-17 18:45:57'),
(176, 'Test MySQL recurring Event', '2020-02-17 18:46:02'),
(177, 'Test MySQL recurring Event', '2020-02-17 18:46:05'),
(178, 'Test MySQL recurring Event', '2020-02-17 18:46:07'),
(179, 'Test MySQL recurring Event', '2020-02-17 18:46:12'),
(180, 'Test MySQL recurring Event', '2020-02-17 18:46:17'),
(181, 'Test MySQL recurring Event', '2020-02-17 18:46:22'),
(182, 'Test MySQL recurring Event', '2020-02-17 18:46:27'),
(183, 'Test MySQL recurring Event', '2020-02-17 18:46:32'),
(184, 'Test MySQL recurring Event', '2020-02-17 18:46:37'),
(185, 'Test MySQL recurring Event', '2020-02-17 18:46:42'),
(186, 'Test MySQL recurring Event', '2020-02-17 18:46:47'),
(187, 'Test MySQL recurring Event', '2020-02-17 18:46:52'),
(188, 'Test MySQL recurring Event', '2020-02-17 18:46:57'),
(189, 'Test MySQL recurring Event', '2020-02-17 18:47:02'),
(190, 'Test MySQL recurring Event', '2020-02-17 18:47:05'),
(191, 'Test MySQL recurring Event', '2020-02-17 18:47:07'),
(192, 'Test MySQL recurring Event', '2020-02-17 18:47:12'),
(193, 'Test MySQL recurring Event', '2020-02-17 18:47:17'),
(194, 'Test MySQL recurring Event', '2020-02-17 18:47:22'),
(195, 'Test MySQL recurring Event', '2020-02-17 18:47:27'),
(196, 'Test MySQL recurring Event', '2020-02-17 18:47:32'),
(197, 'Test MySQL recurring Event', '2020-02-17 18:47:37'),
(198, 'Test MySQL recurring Event', '2020-02-17 18:47:42'),
(199, 'Test MySQL recurring Event', '2020-02-17 18:47:47'),
(200, 'Test MySQL recurring Event', '2020-02-17 18:47:52'),
(201, 'Test MySQL recurring Event', '2020-02-17 18:47:57'),
(202, 'Test MySQL recurring Event', '2020-02-17 18:48:02'),
(203, 'Test MySQL recurring Event', '2020-02-17 18:48:05'),
(204, 'Test MySQL recurring Event', '2020-02-17 18:48:07'),
(205, 'Test MySQL recurring Event', '2020-02-17 18:48:12'),
(206, 'Test MySQL recurring Event', '2020-02-17 18:48:17'),
(207, 'Test MySQL recurring Event', '2020-02-17 18:48:22'),
(208, 'Test MySQL recurring Event', '2020-02-17 18:48:27'),
(209, 'Test MySQL recurring Event', '2020-02-17 18:48:32'),
(210, 'Test MySQL recurring Event', '2020-02-17 18:48:37'),
(211, 'Test MySQL recurring Event', '2020-02-17 18:48:42'),
(212, 'Test MySQL recurring Event', '2020-02-17 18:48:47'),
(213, 'Test MySQL recurring Event', '2020-02-17 18:48:52'),
(214, 'Test MySQL recurring Event', '2020-02-17 18:48:57'),
(215, 'Test MySQL recurring Event', '2020-02-17 18:49:02'),
(216, 'Test MySQL recurring Event', '2020-02-17 18:49:05'),
(217, 'Test MySQL recurring Event', '2020-02-17 18:49:07'),
(218, 'Test MySQL recurring Event', '2020-02-17 18:49:12'),
(219, 'Test MySQL recurring Event', '2020-02-17 18:49:17'),
(220, 'Test MySQL recurring Event', '2020-02-17 18:49:22'),
(221, 'Test MySQL recurring Event', '2020-02-17 18:49:27'),
(222, 'Test MySQL recurring Event', '2020-02-17 18:49:32'),
(223, 'Test MySQL recurring Event', '2020-02-17 18:49:37'),
(224, 'Test MySQL recurring Event', '2020-02-17 18:49:42'),
(225, 'Test MySQL recurring Event', '2020-02-17 18:49:47'),
(226, 'Test MySQL recurring Event', '2020-02-17 18:49:52'),
(227, 'Test MySQL recurring Event', '2020-02-17 18:49:57'),
(228, 'Test MySQL recurring Event', '2020-02-17 18:50:02'),
(229, 'Test MySQL recurring Event', '2020-02-17 18:50:05'),
(230, 'Test MySQL recurring Event', '2020-02-17 18:50:07'),
(231, 'Test MySQL recurring Event', '2020-02-17 18:50:12'),
(232, 'Test MySQL recurring Event', '2020-02-17 18:50:17'),
(233, 'Test MySQL recurring Event', '2020-02-17 18:50:22'),
(234, 'Test MySQL recurring Event', '2020-02-17 18:50:27'),
(235, 'Test MySQL recurring Event', '2020-02-17 18:50:32'),
(236, 'Test MySQL recurring Event', '2020-02-17 18:50:37'),
(237, 'Test MySQL recurring Event', '2020-02-17 18:50:42'),
(238, 'Test MySQL recurring Event', '2020-02-17 18:50:47'),
(239, 'Test MySQL recurring Event', '2020-02-17 18:50:52'),
(240, 'Test MySQL recurring Event', '2020-02-17 18:50:57'),
(241, 'Test MySQL recurring Event', '2020-02-17 18:51:02'),
(242, 'Test MySQL recurring Event', '2020-02-17 18:51:05'),
(243, 'Test MySQL recurring Event', '2020-02-17 18:51:07'),
(244, 'Test MySQL recurring Event', '2020-02-17 18:51:12'),
(245, 'Test MySQL recurring Event', '2020-02-17 18:51:17'),
(246, 'Test MySQL recurring Event', '2020-02-17 18:51:22'),
(247, 'Test MySQL recurring Event', '2020-02-17 18:51:27'),
(248, 'Test MySQL recurring Event', '2020-02-17 18:51:32'),
(249, 'Test MySQL recurring Event', '2020-02-17 18:51:37'),
(250, 'Test MySQL recurring Event', '2020-02-17 18:51:42'),
(251, 'Test MySQL recurring Event', '2020-02-17 18:51:47'),
(252, 'Test MySQL recurring Event', '2020-02-17 18:51:52'),
(253, 'Test MySQL recurring Event', '2020-02-17 18:51:57'),
(254, 'Test MySQL recurring Event', '2020-02-17 18:52:02'),
(255, 'Test MySQL recurring Event', '2020-02-17 18:52:05'),
(256, 'Test MySQL recurring Event', '2020-02-17 18:52:07'),
(257, 'Test MySQL recurring Event', '2020-02-17 18:52:12'),
(258, 'Test MySQL recurring Event', '2020-02-17 18:52:17'),
(259, 'Test MySQL recurring Event', '2020-02-17 18:52:22'),
(260, 'Test MySQL recurring Event', '2020-02-17 18:52:27'),
(261, 'Test MySQL recurring Event', '2020-02-17 18:52:32'),
(262, 'Test MySQL recurring Event', '2020-02-17 18:52:37'),
(263, 'Test MySQL recurring Event', '2020-02-17 18:52:42'),
(264, 'Test MySQL recurring Event', '2020-02-17 18:52:47'),
(265, 'Test MySQL recurring Event', '2020-02-17 18:52:52'),
(266, 'Test MySQL recurring Event', '2020-02-17 18:52:57'),
(267, 'Test MySQL recurring Event', '2020-02-17 18:53:02'),
(268, 'Test MySQL recurring Event', '2020-02-17 18:53:05'),
(269, 'Test MySQL recurring Event', '2020-02-17 18:53:07'),
(270, 'Test MySQL recurring Event', '2020-02-17 18:53:12'),
(271, 'Test MySQL recurring Event', '2020-02-17 18:53:17'),
(272, 'Test MySQL recurring Event', '2020-02-17 18:53:22'),
(273, 'Test MySQL recurring Event', '2020-02-17 18:53:27'),
(274, 'Test MySQL recurring Event', '2020-02-17 18:53:32'),
(275, 'Test MySQL recurring Event', '2020-02-17 18:53:37'),
(276, 'Test MySQL recurring Event', '2020-02-17 18:53:42'),
(277, 'Test MySQL recurring Event', '2020-02-17 18:53:47'),
(278, 'Test MySQL recurring Event', '2020-02-17 18:53:52'),
(279, 'Test MySQL recurring Event', '2020-02-17 18:53:57'),
(280, 'Test MySQL recurring Event', '2020-02-17 18:54:02'),
(281, 'Test MySQL recurring Event', '2020-02-17 18:54:05'),
(282, 'Test MySQL recurring Event', '2020-02-17 18:54:07'),
(283, 'Test MySQL recurring Event', '2020-02-17 18:54:12'),
(284, 'Test MySQL recurring Event', '2020-02-17 18:54:17'),
(285, 'Test MySQL recurring Event', '2020-02-17 18:54:22'),
(286, 'Test MySQL recurring Event', '2020-02-17 18:54:27'),
(287, 'Test MySQL recurring Event', '2020-02-17 18:54:32'),
(288, 'Test MySQL recurring Event', '2020-02-17 18:54:37'),
(289, 'Test MySQL recurring Event', '2020-02-17 18:54:42'),
(290, 'Test MySQL recurring Event', '2020-02-17 18:54:47'),
(291, 'Test MySQL recurring Event', '2020-02-17 18:54:52'),
(292, 'Test MySQL recurring Event', '2020-02-17 18:54:57'),
(293, 'Test MySQL recurring Event', '2020-02-17 18:55:02'),
(294, 'Test MySQL recurring Event', '2020-02-17 18:55:05'),
(295, 'Test MySQL recurring Event', '2020-02-17 18:55:07'),
(296, 'Test MySQL recurring Event', '2020-02-17 18:55:12'),
(297, 'Test MySQL recurring Event', '2020-02-17 18:55:17'),
(298, 'Test MySQL recurring Event', '2020-02-17 18:55:22'),
(299, 'Test MySQL recurring Event', '2020-02-17 18:55:27'),
(300, 'Test MySQL recurring Event', '2020-02-17 18:55:32'),
(301, 'Test MySQL recurring Event', '2020-02-17 18:55:37'),
(302, 'Test MySQL recurring Event', '2020-02-17 18:55:42'),
(303, 'Test MySQL recurring Event', '2020-02-17 18:55:47'),
(304, 'Test MySQL recurring Event', '2020-02-17 18:55:52'),
(305, 'Test MySQL recurring Event', '2020-02-17 18:55:57'),
(306, 'Test MySQL recurring Event', '2020-02-17 18:56:02'),
(307, 'Test MySQL recurring Event', '2020-02-17 18:56:05'),
(308, 'Test MySQL recurring Event', '2020-02-17 18:56:07'),
(309, 'Test MySQL recurring Event', '2020-02-17 18:56:12'),
(310, 'Test MySQL recurring Event', '2020-02-17 18:56:17'),
(311, 'Test MySQL recurring Event', '2020-02-17 18:56:22'),
(312, 'Test MySQL recurring Event', '2020-02-17 18:56:27'),
(313, 'Test MySQL recurring Event', '2020-02-17 18:56:32'),
(314, 'Test MySQL recurring Event', '2020-02-17 18:56:37'),
(315, 'Test MySQL recurring Event', '2020-02-17 18:56:42'),
(316, 'Test MySQL recurring Event', '2020-02-17 18:56:47'),
(317, 'Test MySQL recurring Event', '2020-02-17 18:56:52'),
(318, 'Test MySQL recurring Event', '2020-02-17 18:56:57'),
(319, 'Test MySQL recurring Event', '2020-02-17 18:57:02'),
(320, 'Test MySQL recurring Event', '2020-02-17 18:57:05'),
(321, 'Test MySQL recurring Event', '2020-02-17 18:57:07'),
(322, 'Test MySQL recurring Event', '2020-02-17 18:57:12'),
(323, 'Test MySQL recurring Event', '2020-02-17 18:57:17'),
(324, 'Test MySQL recurring Event', '2020-02-17 18:57:22'),
(325, 'Test MySQL recurring Event', '2020-02-17 18:57:27'),
(326, 'Test MySQL recurring Event', '2020-02-17 18:57:32'),
(327, 'Test MySQL recurring Event', '2020-02-17 18:57:37'),
(328, 'Test MySQL recurring Event', '2020-02-17 18:57:42'),
(329, 'Test MySQL recurring Event', '2020-02-17 18:57:47'),
(330, 'Test MySQL recurring Event', '2020-02-17 18:57:52'),
(331, 'Test MySQL recurring Event', '2020-02-17 18:57:57'),
(332, 'Test MySQL recurring Event', '2020-02-17 18:58:02'),
(333, 'Test MySQL recurring Event', '2020-02-17 18:58:05'),
(334, 'Test MySQL recurring Event', '2020-02-17 18:58:07'),
(335, 'Test MySQL recurring Event', '2020-02-17 18:58:12'),
(336, 'Test MySQL recurring Event', '2020-02-17 18:58:17'),
(337, 'Test MySQL recurring Event', '2020-02-17 18:58:22'),
(338, 'Test MySQL recurring Event', '2020-02-17 18:58:27'),
(339, 'Test MySQL recurring Event', '2020-02-17 18:58:32'),
(340, 'Test MySQL recurring Event', '2020-02-17 18:58:37'),
(341, 'Test MySQL recurring Event', '2020-02-17 18:58:42'),
(342, 'Test MySQL recurring Event', '2020-02-17 18:58:47'),
(343, 'Test MySQL recurring Event', '2020-02-17 18:58:52'),
(344, 'Test MySQL recurring Event', '2020-02-17 18:58:57'),
(345, 'Test MySQL recurring Event', '2020-02-17 18:59:02'),
(346, 'Test MySQL recurring Event', '2020-02-17 18:59:05'),
(347, 'Test MySQL recurring Event', '2020-02-17 18:59:07'),
(348, 'Test MySQL recurring Event', '2020-02-17 18:59:12'),
(349, 'Test MySQL recurring Event', '2020-02-17 18:59:17'),
(350, 'Test MySQL recurring Event', '2020-02-17 18:59:22'),
(351, 'Test MySQL recurring Event', '2020-02-17 18:59:27'),
(352, 'Test MySQL recurring Event', '2020-02-17 18:59:32'),
(353, 'Test MySQL recurring Event', '2020-02-17 18:59:37'),
(354, 'Test MySQL recurring Event', '2020-02-17 18:59:42'),
(355, 'Test MySQL recurring Event', '2020-02-17 18:59:47'),
(356, 'Test MySQL recurring Event', '2020-02-17 18:59:52'),
(357, 'Test MySQL recurring Event', '2020-02-17 18:59:57'),
(358, 'Test MySQL recurring Event', '2020-02-17 19:00:02'),
(359, 'Test MySQL recurring Event', '2020-02-17 19:00:05'),
(360, 'Test MySQL recurring Event', '2020-02-17 19:00:07'),
(361, 'Test MySQL recurring Event', '2020-02-17 19:00:12'),
(362, 'Test MySQL recurring Event', '2020-02-17 19:00:17'),
(363, 'Test MySQL recurring Event', '2020-02-17 19:00:22'),
(364, 'Test MySQL recurring Event', '2020-02-17 19:00:27'),
(365, 'Test MySQL recurring Event', '2020-02-17 19:00:32'),
(366, 'Test MySQL recurring Event', '2020-02-17 19:00:37'),
(367, 'Test MySQL recurring Event', '2020-02-17 19:00:42'),
(368, 'Test MySQL recurring Event', '2020-02-17 19:00:47'),
(369, 'Test MySQL recurring Event', '2020-02-17 19:00:52'),
(370, 'Test MySQL recurring Event', '2020-02-17 19:00:57'),
(371, 'Test MySQL recurring Event', '2020-02-17 19:01:02'),
(372, 'Test MySQL recurring Event', '2020-02-17 19:01:05'),
(373, 'Test MySQL recurring Event', '2020-02-17 19:01:07'),
(374, 'Test MySQL recurring Event', '2020-02-17 19:01:12'),
(375, 'Test MySQL recurring Event', '2020-02-17 19:01:17'),
(376, 'Test MySQL recurring Event', '2020-02-17 19:01:22'),
(377, 'Test MySQL recurring Event', '2020-02-17 19:01:27'),
(378, 'Test MySQL recurring Event', '2020-02-17 19:01:32'),
(379, 'Test MySQL recurring Event', '2020-02-17 19:01:37'),
(380, 'Test MySQL recurring Event', '2020-02-17 19:01:42'),
(381, 'Test MySQL recurring Event', '2020-02-17 19:01:47'),
(382, 'Test MySQL recurring Event', '2020-02-17 19:01:52'),
(383, 'Test MySQL recurring Event', '2020-02-17 19:01:57'),
(384, 'Test MySQL recurring Event', '2020-02-17 19:02:02'),
(385, 'Test MySQL recurring Event', '2020-02-17 19:02:05'),
(386, 'Test MySQL recurring Event', '2020-02-17 19:02:07'),
(387, 'Test MySQL recurring Event', '2020-02-17 19:02:12'),
(388, 'Test MySQL recurring Event', '2020-02-17 19:02:17'),
(389, 'Test MySQL recurring Event', '2020-02-17 19:02:22'),
(390, 'Test MySQL recurring Event', '2020-02-17 19:02:27'),
(391, 'Test MySQL recurring Event', '2020-02-17 19:02:32'),
(392, 'Test MySQL recurring Event', '2020-02-17 19:02:37'),
(393, 'Test MySQL recurring Event', '2020-02-17 19:02:42'),
(394, 'Test MySQL recurring Event', '2020-02-17 19:02:47'),
(395, 'Test MySQL recurring Event', '2020-02-17 19:02:52'),
(396, 'Test MySQL recurring Event', '2020-02-17 19:02:57'),
(397, 'Test MySQL recurring Event', '2020-02-17 19:03:02'),
(398, 'Test MySQL recurring Event', '2020-02-17 19:03:05'),
(399, 'Test MySQL recurring Event', '2020-02-17 19:03:07'),
(400, 'Test MySQL recurring Event', '2020-02-17 19:03:12'),
(401, 'Test MySQL recurring Event', '2020-02-17 19:03:17'),
(402, 'Test MySQL recurring Event', '2020-02-17 19:03:22'),
(403, 'Test MySQL recurring Event', '2020-02-17 19:03:27'),
(404, 'Test MySQL recurring Event', '2020-02-17 19:03:32'),
(405, 'Test MySQL recurring Event', '2020-02-17 19:03:37'),
(406, 'Test MySQL recurring Event', '2020-02-17 19:03:42'),
(407, 'Test MySQL recurring Event', '2020-02-17 19:03:47'),
(408, 'Test MySQL recurring Event', '2020-02-17 19:03:52'),
(409, 'Test MySQL recurring Event', '2020-02-17 19:03:57'),
(410, 'Test MySQL recurring Event', '2020-02-17 19:04:02'),
(411, 'Test MySQL recurring Event', '2020-02-17 19:04:05'),
(412, 'Test MySQL recurring Event', '2020-02-17 19:04:07'),
(413, 'Test MySQL recurring Event', '2020-02-17 19:04:12'),
(414, 'Test MySQL recurring Event', '2020-02-17 19:04:17'),
(415, 'Test MySQL recurring Event', '2020-02-17 19:04:22'),
(416, 'Test MySQL recurring Event', '2020-02-17 19:04:27'),
(417, 'Test MySQL recurring Event', '2020-02-17 19:04:32'),
(418, 'Test MySQL recurring Event', '2020-02-17 19:04:37'),
(419, 'Test MySQL recurring Event', '2020-02-17 19:04:42'),
(420, 'Test MySQL recurring Event', '2020-02-17 19:04:47'),
(421, 'Test MySQL recurring Event', '2020-02-17 19:04:52'),
(422, 'Test MySQL recurring Event', '2020-02-17 19:04:57'),
(423, 'Test MySQL recurring Event', '2020-02-17 19:05:02'),
(424, 'Test MySQL recurring Event', '2020-02-17 19:05:05'),
(425, 'Test MySQL recurring Event', '2020-02-17 19:05:07'),
(426, 'Test MySQL recurring Event', '2020-02-17 19:05:12'),
(427, 'Test MySQL recurring Event', '2020-02-17 19:05:17'),
(428, 'Test MySQL recurring Event', '2020-02-17 19:05:22'),
(429, 'Test MySQL recurring Event', '2020-02-17 19:05:27'),
(430, 'Test MySQL recurring Event', '2020-02-17 19:05:32'),
(431, 'Test MySQL recurring Event', '2020-02-17 19:05:37'),
(432, 'Test MySQL recurring Event', '2020-02-17 19:05:42'),
(433, 'Test MySQL recurring Event', '2020-02-17 19:05:47'),
(434, 'Test MySQL recurring Event', '2020-02-17 19:05:52'),
(435, 'Test MySQL recurring Event', '2020-02-17 19:05:57'),
(436, 'Test MySQL recurring Event', '2020-02-17 19:06:02'),
(437, 'Test MySQL recurring Event', '2020-02-17 19:06:05'),
(438, 'Test MySQL recurring Event', '2020-02-17 19:06:07'),
(439, 'Test MySQL recurring Event', '2020-02-17 19:06:12'),
(440, 'Test MySQL recurring Event', '2020-02-17 19:06:17'),
(441, 'Test MySQL recurring Event', '2020-02-17 19:06:22'),
(442, 'Test MySQL recurring Event', '2020-02-17 19:06:27'),
(443, 'Test MySQL recurring Event', '2020-02-17 19:06:32'),
(444, 'Test MySQL recurring Event', '2020-02-17 19:06:37'),
(445, 'Test MySQL recurring Event', '2020-02-17 19:06:42'),
(446, 'Test MySQL recurring Event', '2020-02-17 19:06:47'),
(447, 'Test MySQL recurring Event', '2020-02-17 19:06:52'),
(448, 'Test MySQL recurring Event', '2020-02-17 19:06:57'),
(449, 'Test MySQL recurring Event', '2020-02-17 19:07:02'),
(450, 'Test MySQL recurring Event', '2020-02-17 19:07:05'),
(451, 'Test MySQL recurring Event', '2020-02-17 19:07:07'),
(452, 'Test MySQL recurring Event', '2020-02-17 19:07:12'),
(453, 'Test MySQL recurring Event', '2020-02-17 19:07:17'),
(454, 'Test MySQL recurring Event', '2020-02-17 19:07:22'),
(455, 'Test MySQL recurring Event', '2020-02-17 19:07:27'),
(456, 'Test MySQL recurring Event', '2020-02-17 19:07:32'),
(457, 'Test MySQL recurring Event', '2020-02-17 19:07:37'),
(458, 'Test MySQL recurring Event', '2020-02-17 19:07:42'),
(459, 'Test MySQL recurring Event', '2020-02-17 19:07:47'),
(460, 'Test MySQL recurring Event', '2020-02-17 19:07:52'),
(461, 'Test MySQL recurring Event', '2020-02-17 19:07:57'),
(462, 'Test MySQL recurring Event', '2020-02-17 19:08:02'),
(463, 'Test MySQL recurring Event', '2020-02-17 19:08:05'),
(464, 'Test MySQL recurring Event', '2020-02-17 19:08:07'),
(465, 'Test MySQL recurring Event', '2020-02-17 19:08:12'),
(466, 'Test MySQL recurring Event', '2020-02-17 19:08:17'),
(467, 'Test MySQL recurring Event', '2020-02-17 19:08:22'),
(468, 'Test MySQL recurring Event', '2020-02-17 19:08:27'),
(469, 'Test MySQL recurring Event', '2020-02-17 19:08:32'),
(470, 'Test MySQL recurring Event', '2020-02-17 19:08:37'),
(471, 'Test MySQL recurring Event', '2020-02-17 19:08:42'),
(472, 'Test MySQL recurring Event', '2020-02-17 19:08:47'),
(473, 'Test MySQL recurring Event', '2020-02-17 19:08:52'),
(474, 'Test MySQL recurring Event', '2020-02-17 19:08:57'),
(475, 'Test MySQL recurring Event', '2020-02-17 19:09:02'),
(476, 'Test MySQL recurring Event', '2020-02-17 19:09:05'),
(477, 'Test MySQL recurring Event', '2020-02-17 19:09:07'),
(478, 'Test MySQL recurring Event', '2020-02-17 19:09:12'),
(479, 'Test MySQL recurring Event', '2020-02-17 19:09:17'),
(480, 'Test MySQL recurring Event', '2020-02-17 19:09:22'),
(481, 'Test MySQL recurring Event', '2020-02-17 19:09:27'),
(482, 'Test MySQL recurring Event', '2020-02-17 19:09:32'),
(483, 'Test MySQL recurring Event', '2020-02-17 19:09:37'),
(484, 'Test MySQL recurring Event', '2020-02-17 19:09:42'),
(485, 'Test MySQL recurring Event', '2020-02-17 19:09:47'),
(486, 'Test MySQL recurring Event', '2020-02-17 19:09:52'),
(487, 'Test MySQL recurring Event', '2020-02-17 19:09:57'),
(488, 'Test MySQL recurring Event', '2020-02-17 19:10:02'),
(489, 'Test MySQL recurring Event', '2020-02-17 19:10:05'),
(490, 'Test MySQL recurring Event', '2020-02-17 19:10:07'),
(491, 'Test MySQL recurring Event', '2020-02-17 19:10:12'),
(492, 'Test MySQL recurring Event', '2020-02-17 19:10:17'),
(493, 'Test MySQL recurring Event', '2020-02-17 19:10:22'),
(494, 'Test MySQL recurring Event', '2020-02-17 19:10:27'),
(495, 'Test MySQL recurring Event', '2020-02-17 19:10:32'),
(496, 'Test MySQL recurring Event', '2020-02-17 19:10:37'),
(497, 'Test MySQL recurring Event', '2020-02-17 19:10:42'),
(498, 'Test MySQL recurring Event', '2020-02-17 19:10:47'),
(499, 'Test MySQL recurring Event', '2020-02-17 19:10:52'),
(500, 'Test MySQL recurring Event', '2020-02-17 19:10:57'),
(501, 'Test MySQL recurring Event', '2020-02-17 19:11:02'),
(502, 'Test MySQL recurring Event', '2020-02-17 19:11:05'),
(503, 'Test MySQL recurring Event', '2020-02-17 19:11:07'),
(504, 'Test MySQL recurring Event', '2020-02-17 19:11:12'),
(505, 'Test MySQL recurring Event', '2020-02-17 19:11:17'),
(506, 'Test MySQL recurring Event', '2020-02-17 19:11:22'),
(507, 'Test MySQL recurring Event', '2020-02-17 19:11:27'),
(508, 'Test MySQL recurring Event', '2020-02-17 19:11:32'),
(509, 'Test MySQL recurring Event', '2020-02-17 19:11:37'),
(510, 'Test MySQL recurring Event', '2020-02-17 19:11:42'),
(511, 'Test MySQL recurring Event', '2020-02-17 19:11:47'),
(512, 'Test MySQL recurring Event', '2020-02-17 19:11:52'),
(513, 'Test MySQL recurring Event', '2020-02-17 19:11:57'),
(514, 'Test MySQL recurring Event', '2020-02-17 19:12:02'),
(515, 'Test MySQL recurring Event', '2020-02-17 19:12:05'),
(516, 'Test MySQL recurring Event', '2020-02-17 19:12:07'),
(517, 'Test MySQL recurring Event', '2020-02-17 19:12:12'),
(518, 'Test MySQL recurring Event', '2020-02-17 19:12:17'),
(519, 'Test MySQL recurring Event', '2020-02-17 19:12:22'),
(520, 'Test MySQL recurring Event', '2020-02-17 19:12:27'),
(521, 'Test MySQL recurring Event', '2020-02-17 19:12:32'),
(522, 'Test MySQL recurring Event', '2020-02-17 19:12:37'),
(523, 'Test MySQL recurring Event', '2020-02-17 19:12:42'),
(524, 'Test MySQL recurring Event', '2020-02-17 19:12:47'),
(525, 'Test MySQL recurring Event', '2020-02-17 19:12:52'),
(526, 'Test MySQL recurring Event', '2020-02-17 19:12:57'),
(527, 'Test MySQL recurring Event', '2020-02-17 19:13:02'),
(528, 'Test MySQL recurring Event', '2020-02-17 19:13:05'),
(529, 'Test MySQL recurring Event', '2020-02-17 19:13:07'),
(530, 'Test MySQL recurring Event', '2020-02-17 19:13:12'),
(531, 'Test MySQL recurring Event', '2020-02-17 19:13:17'),
(532, 'Test MySQL recurring Event', '2020-02-17 19:13:22'),
(533, 'Test MySQL recurring Event', '2020-02-17 19:13:27'),
(534, 'Test MySQL recurring Event', '2020-02-17 19:13:32'),
(535, 'Test MySQL recurring Event', '2020-02-17 19:13:37'),
(536, 'Test MySQL recurring Event', '2020-02-17 19:13:42'),
(537, 'Test MySQL recurring Event', '2020-02-17 19:13:47'),
(538, 'Test MySQL recurring Event', '2020-02-17 19:13:52'),
(539, 'Test MySQL recurring Event', '2020-02-17 19:13:57'),
(540, 'Test MySQL recurring Event', '2020-02-17 19:14:02'),
(541, 'Test MySQL recurring Event', '2020-02-17 19:14:05'),
(542, 'Test MySQL recurring Event', '2020-02-17 19:14:07'),
(543, 'Test MySQL recurring Event', '2020-02-17 19:14:12'),
(544, 'Test MySQL recurring Event', '2020-02-17 19:14:17'),
(545, 'Test MySQL recurring Event', '2020-02-17 19:14:22'),
(546, 'Test MySQL recurring Event', '2020-02-17 19:14:27'),
(547, 'Test MySQL recurring Event', '2020-02-17 19:14:32'),
(548, 'Test MySQL recurring Event', '2020-02-17 19:14:37'),
(549, 'Test MySQL recurring Event', '2020-02-17 19:14:42'),
(550, 'Test MySQL recurring Event', '2020-02-17 19:14:47'),
(551, 'Test MySQL recurring Event', '2020-02-17 19:14:52'),
(552, 'Test MySQL recurring Event', '2020-02-17 19:14:57'),
(553, 'Test MySQL recurring Event', '2020-02-17 19:15:02'),
(554, 'Test MySQL recurring Event', '2020-02-17 19:15:05'),
(555, 'Test MySQL recurring Event', '2020-02-17 19:15:07'),
(556, 'Test MySQL recurring Event', '2020-02-17 19:15:12'),
(557, 'Test MySQL recurring Event', '2020-02-17 19:15:17'),
(558, 'Test MySQL recurring Event', '2020-02-17 19:15:22'),
(559, 'Test MySQL recurring Event', '2020-02-17 19:15:27'),
(560, 'Test MySQL recurring Event', '2020-02-17 19:15:32'),
(561, 'Test MySQL recurring Event', '2020-02-17 19:15:37'),
(562, 'Test MySQL recurring Event', '2020-02-17 19:15:42'),
(563, 'Test MySQL recurring Event', '2020-02-17 19:15:47'),
(564, 'Test MySQL recurring Event', '2020-02-17 19:15:52'),
(565, 'Test MySQL recurring Event', '2020-02-17 19:15:57'),
(566, 'Test MySQL recurring Event', '2020-02-17 19:16:02'),
(567, 'Test MySQL recurring Event', '2020-02-17 19:16:05'),
(568, 'Test MySQL recurring Event', '2020-02-17 19:16:07'),
(569, 'Test MySQL recurring Event', '2020-02-17 19:16:12'),
(570, 'Test MySQL recurring Event', '2020-02-17 19:16:17'),
(571, 'Test MySQL recurring Event', '2020-02-17 19:16:22'),
(572, 'Test MySQL recurring Event', '2020-02-17 19:16:27'),
(573, 'Test MySQL recurring Event', '2020-02-17 19:16:32'),
(574, 'Test MySQL recurring Event', '2020-02-17 19:16:37'),
(575, 'Test MySQL recurring Event', '2020-02-17 19:16:42'),
(576, 'Test MySQL recurring Event', '2020-02-17 19:16:47'),
(577, 'Test MySQL recurring Event', '2020-02-17 19:16:52'),
(578, 'Test MySQL recurring Event', '2020-02-17 19:16:57'),
(579, 'Test MySQL recurring Event', '2020-02-17 19:17:02'),
(580, 'Test MySQL recurring Event', '2020-02-17 19:17:05'),
(581, 'Test MySQL recurring Event', '2020-02-17 19:17:07'),
(582, 'Test MySQL recurring Event', '2020-02-17 19:17:12'),
(583, 'Test MySQL recurring Event', '2020-02-17 19:17:17'),
(584, 'Test MySQL recurring Event', '2020-02-17 19:17:22'),
(585, 'Test MySQL recurring Event', '2020-02-17 19:17:27'),
(586, 'Test MySQL recurring Event', '2020-02-17 19:17:32'),
(587, 'Test MySQL recurring Event', '2020-02-17 19:17:37'),
(588, 'Test MySQL recurring Event', '2020-02-17 19:17:42'),
(589, 'Test MySQL recurring Event', '2020-02-17 19:17:47'),
(590, 'Test MySQL recurring Event', '2020-02-17 19:17:52'),
(591, 'Test MySQL recurring Event', '2020-02-17 19:17:57'),
(592, 'Test MySQL recurring Event', '2020-02-17 19:18:02'),
(593, 'Test MySQL recurring Event', '2020-02-17 19:18:05'),
(594, 'Test MySQL recurring Event', '2020-02-17 19:18:07'),
(595, 'Test MySQL recurring Event', '2020-02-17 19:18:12'),
(596, 'Test MySQL recurring Event', '2020-02-17 19:18:17'),
(597, 'Test MySQL recurring Event', '2020-02-17 19:18:22'),
(598, 'Test MySQL recurring Event', '2020-02-17 19:18:27'),
(599, 'Test MySQL recurring Event', '2020-02-17 19:18:32'),
(600, 'Test MySQL recurring Event', '2020-02-17 19:18:37'),
(601, 'Test MySQL recurring Event', '2020-02-17 19:18:42'),
(602, 'Test MySQL recurring Event', '2020-02-17 19:18:47'),
(603, 'Test MySQL recurring Event', '2020-02-17 19:18:52'),
(604, 'Test MySQL recurring Event', '2020-02-17 19:18:57'),
(605, 'Test MySQL recurring Event', '2020-02-17 19:19:02'),
(606, 'Test MySQL recurring Event', '2020-02-17 19:19:05'),
(607, 'Test MySQL recurring Event', '2020-02-17 19:19:07'),
(608, 'Test MySQL recurring Event', '2020-02-17 19:19:12'),
(609, 'Test MySQL recurring Event', '2020-02-17 19:19:17'),
(610, 'Test MySQL recurring Event', '2020-02-17 19:19:22'),
(611, 'Test MySQL recurring Event', '2020-02-17 19:19:27'),
(612, 'Test MySQL recurring Event', '2020-02-17 19:19:32'),
(613, 'Test MySQL recurring Event', '2020-02-17 19:19:37'),
(614, 'Test MySQL recurring Event', '2020-02-17 19:19:42'),
(615, 'Test MySQL recurring Event', '2020-02-17 19:19:47'),
(616, 'Test MySQL recurring Event', '2020-02-17 19:19:52'),
(617, 'Test MySQL recurring Event', '2020-02-17 19:19:57'),
(618, 'Test MySQL recurring Event', '2020-02-17 19:20:02'),
(619, 'Test MySQL recurring Event', '2020-02-17 19:20:05'),
(620, 'Test MySQL recurring Event', '2020-02-17 19:20:07'),
(621, 'Test MySQL recurring Event', '2020-02-17 19:20:12'),
(622, 'Test MySQL recurring Event', '2020-02-17 19:20:17'),
(623, 'Test MySQL recurring Event', '2020-02-17 19:20:22'),
(624, 'Test MySQL recurring Event', '2020-02-17 19:20:27'),
(625, 'Test MySQL recurring Event', '2020-02-17 19:20:32'),
(626, 'Test MySQL recurring Event', '2020-02-17 19:20:37'),
(627, 'Test MySQL recurring Event', '2020-02-17 19:20:42'),
(628, 'Test MySQL recurring Event', '2020-02-17 19:20:47'),
(629, 'Test MySQL recurring Event', '2020-02-17 19:20:52'),
(630, 'Test MySQL recurring Event', '2020-02-17 19:20:57'),
(631, 'Test MySQL recurring Event', '2020-02-17 19:21:02'),
(632, 'Test MySQL recurring Event', '2020-02-17 19:21:05'),
(633, 'Test MySQL recurring Event', '2020-02-17 19:21:07'),
(634, 'Test MySQL recurring Event', '2020-02-17 19:21:12'),
(635, 'Test MySQL recurring Event', '2020-02-17 19:21:17'),
(636, 'Test MySQL recurring Event', '2020-02-17 19:21:22'),
(637, 'Test MySQL recurring Event', '2020-02-17 19:21:27'),
(638, 'Test MySQL recurring Event', '2020-02-17 19:21:32'),
(639, 'Test MySQL recurring Event', '2020-02-17 19:21:37'),
(640, 'Test MySQL recurring Event', '2020-02-17 19:21:42'),
(641, 'Test MySQL recurring Event', '2020-02-17 19:21:47'),
(642, 'Test MySQL recurring Event', '2020-02-17 19:21:52'),
(643, 'Test MySQL recurring Event', '2020-02-17 19:21:57'),
(644, 'Test MySQL recurring Event', '2020-02-17 19:22:02'),
(645, 'Test MySQL recurring Event', '2020-02-17 19:22:05'),
(646, 'Test MySQL recurring Event', '2020-02-17 19:22:07'),
(647, 'Test MySQL recurring Event', '2020-02-17 19:22:12'),
(648, 'Test MySQL recurring Event', '2020-02-17 19:22:17'),
(649, 'Test MySQL recurring Event', '2020-02-17 19:22:22'),
(650, 'Test MySQL recurring Event', '2020-02-17 19:22:27'),
(651, 'Test MySQL recurring Event', '2020-02-17 19:22:32'),
(652, 'Test MySQL recurring Event', '2020-02-17 19:22:37'),
(653, 'Test MySQL recurring Event', '2020-02-17 19:22:42'),
(654, 'Test MySQL recurring Event', '2020-02-17 19:22:47'),
(655, 'Test MySQL recurring Event', '2020-02-17 19:22:52'),
(656, 'Test MySQL recurring Event', '2020-02-17 19:22:57'),
(657, 'Test MySQL recurring Event', '2020-02-17 19:23:02'),
(658, 'Test MySQL recurring Event', '2020-02-17 19:23:05'),
(659, 'Test MySQL recurring Event', '2020-02-17 19:23:07'),
(660, 'Test MySQL recurring Event', '2020-02-17 19:23:12'),
(661, 'Test MySQL recurring Event', '2020-02-17 19:23:17'),
(662, 'Test MySQL recurring Event', '2020-02-17 19:23:22'),
(663, 'Test MySQL recurring Event', '2020-02-17 19:23:27'),
(664, 'Test MySQL recurring Event', '2020-02-17 19:23:32'),
(665, 'Test MySQL recurring Event', '2020-02-17 19:23:37'),
(666, 'Test MySQL recurring Event', '2020-02-17 19:23:42'),
(667, 'Test MySQL recurring Event', '2020-02-17 19:23:47'),
(668, 'Test MySQL recurring Event', '2020-02-17 19:23:52'),
(669, 'Test MySQL recurring Event', '2020-02-17 19:23:57'),
(670, 'Test MySQL recurring Event', '2020-02-17 19:24:02'),
(671, 'Test MySQL recurring Event', '2020-02-17 19:24:05'),
(672, 'Test MySQL recurring Event', '2020-02-17 19:24:07'),
(673, 'Test MySQL recurring Event', '2020-02-17 19:24:12'),
(674, 'Test MySQL recurring Event', '2020-02-17 19:24:17'),
(675, 'Test MySQL recurring Event', '2020-02-17 19:24:22'),
(676, 'Test MySQL recurring Event', '2020-02-17 19:24:27'),
(677, 'Test MySQL recurring Event', '2020-02-17 19:24:32'),
(678, 'Test MySQL recurring Event', '2020-02-17 19:24:37'),
(679, 'Test MySQL recurring Event', '2020-02-17 19:24:42'),
(680, 'Test MySQL recurring Event', '2020-02-17 19:24:47'),
(681, 'Test MySQL recurring Event', '2020-02-17 19:24:52'),
(682, 'Test MySQL recurring Event', '2020-02-17 19:24:57'),
(683, 'Test MySQL recurring Event', '2020-02-17 19:25:02'),
(684, 'Test MySQL recurring Event', '2020-02-17 19:25:05'),
(685, 'Test MySQL recurring Event', '2020-02-17 19:25:07'),
(686, 'Test MySQL recurring Event', '2020-02-17 19:25:12'),
(687, 'Test MySQL recurring Event', '2020-02-17 19:25:17'),
(688, 'Test MySQL recurring Event', '2020-02-17 19:25:22'),
(689, 'Test MySQL recurring Event', '2020-02-17 19:25:27'),
(690, 'Test MySQL recurring Event', '2020-02-17 19:25:32'),
(691, 'Test MySQL recurring Event', '2020-02-17 19:25:37'),
(692, 'Test MySQL recurring Event', '2020-02-17 19:25:42'),
(693, 'Test MySQL recurring Event', '2020-02-17 19:25:47'),
(694, 'Test MySQL recurring Event', '2020-02-17 19:25:52'),
(695, 'Test MySQL recurring Event', '2020-02-17 19:25:57'),
(696, 'Test MySQL recurring Event', '2020-02-17 19:26:02'),
(697, 'Test MySQL recurring Event', '2020-02-17 19:26:05'),
(698, 'Test MySQL recurring Event', '2020-02-17 19:26:07'),
(699, 'Test MySQL recurring Event', '2020-02-17 19:26:12'),
(700, 'Test MySQL recurring Event', '2020-02-17 19:26:17'),
(701, 'Test MySQL recurring Event', '2020-02-17 19:26:22'),
(702, 'Test MySQL recurring Event', '2020-02-17 19:26:27'),
(703, 'Test MySQL recurring Event', '2020-02-17 19:26:32'),
(704, 'Test MySQL recurring Event', '2020-02-17 19:26:37'),
(705, 'Test MySQL recurring Event', '2020-02-17 19:26:42'),
(706, 'Test MySQL recurring Event', '2020-02-17 19:26:47'),
(707, 'Test MySQL recurring Event', '2020-02-17 19:26:52'),
(708, 'Test MySQL recurring Event', '2020-02-17 19:26:57'),
(709, 'Test MySQL recurring Event', '2020-02-17 19:27:02'),
(710, 'Test MySQL recurring Event', '2020-02-17 19:27:05'),
(711, 'Test MySQL recurring Event', '2020-02-17 19:27:07'),
(712, 'Test MySQL recurring Event', '2020-02-17 19:27:12'),
(713, 'Test MySQL recurring Event', '2020-02-17 19:27:17'),
(714, 'Test MySQL recurring Event', '2020-02-17 19:27:22'),
(715, 'Test MySQL recurring Event', '2020-02-17 19:27:27'),
(716, 'Test MySQL recurring Event', '2020-02-17 19:27:32'),
(717, 'Test MySQL recurring Event', '2020-02-17 19:27:37'),
(718, 'Test MySQL recurring Event', '2020-02-17 19:27:42'),
(719, 'Test MySQL recurring Event', '2020-02-17 19:27:47'),
(720, 'Test MySQL recurring Event', '2020-02-17 19:27:52'),
(721, 'Test MySQL recurring Event', '2020-02-17 19:27:57'),
(722, 'Test MySQL recurring Event', '2020-02-17 19:28:02'),
(723, 'Test MySQL recurring Event', '2020-02-17 19:28:05'),
(724, 'Test MySQL recurring Event', '2020-02-17 19:28:07'),
(725, 'Test MySQL recurring Event', '2020-02-17 19:28:12'),
(726, 'Test MySQL recurring Event', '2020-02-17 19:28:17'),
(727, 'Test MySQL recurring Event', '2020-02-17 19:28:22'),
(728, 'Test MySQL recurring Event', '2020-02-17 19:28:27'),
(729, 'Test MySQL recurring Event', '2020-02-17 19:28:32'),
(730, 'Test MySQL recurring Event', '2020-02-17 19:28:37'),
(731, 'Test MySQL recurring Event', '2020-02-17 19:28:42'),
(732, 'Test MySQL recurring Event', '2020-02-17 19:28:47'),
(733, 'Test MySQL recurring Event', '2020-02-17 19:28:52'),
(734, 'Test MySQL recurring Event', '2020-02-17 19:28:57'),
(735, 'Test MySQL recurring Event', '2020-02-17 19:29:02'),
(736, 'Test MySQL recurring Event', '2020-02-17 19:29:05'),
(737, 'Test MySQL recurring Event', '2020-02-17 19:29:07'),
(738, 'Test MySQL recurring Event', '2020-02-17 19:29:12'),
(739, 'Test MySQL recurring Event', '2020-02-17 19:29:17'),
(740, 'Test MySQL recurring Event', '2020-02-17 19:29:22'),
(741, 'Test MySQL recurring Event', '2020-02-17 19:29:27'),
(742, 'Test MySQL recurring Event', '2020-02-17 19:29:32'),
(743, 'Test MySQL recurring Event', '2020-02-17 19:29:37'),
(744, 'Test MySQL recurring Event', '2020-02-17 19:29:42'),
(745, 'Test MySQL recurring Event', '2020-02-17 19:29:47'),
(746, 'Test MySQL recurring Event', '2020-02-17 19:29:52'),
(747, 'Test MySQL recurring Event', '2020-02-17 19:29:57'),
(748, 'Test MySQL recurring Event', '2020-02-17 19:30:02'),
(749, 'Test MySQL recurring Event', '2020-02-17 19:30:07'),
(750, 'Test MySQL recurring Event', '2020-02-17 19:30:12'),
(751, 'Test MySQL recurring Event', '2020-02-17 19:30:17'),
(752, 'Test MySQL recurring Event', '2020-02-17 19:30:22'),
(753, 'Test MySQL recurring Event', '2020-02-17 19:30:27'),
(754, 'Test MySQL recurring Event', '2020-02-17 19:30:32'),
(755, 'Test MySQL recurring Event', '2020-02-17 19:30:37');

-- --------------------------------------------------------

--
-- Struttura della tabella `mycustomers20210202`
--

CREATE TABLE `mycustomers20210202` (
  `customerNumber` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `mycustomers20210202`
--

INSERT INTO `mycustomers20210202` (`customerNumber`) VALUES
(186),
(187),
(201),
(240),
...
INSERT INTO `params` (`ivaSTD`, `minBonus`, `id_param`, `nomebonus`, `bonus`, `credit1`, `msg1`, `credit2`, `msg2`, `credit3`, `msg3`, `msgover`) VALUES
('0.220', '20000.00', 1, 'christmas', '5000.00', 60000, 'STD', 110000, 'SILVER', 150000, 'GOLD', 'PLATINUM');
...
--
-- Struttura stand-in per le viste `v_all_sale`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_all_sale` (
...
,`totsale` decimal(20,2)
,`totcost` decimal(20,2)
,`totricavo` decimal(21,2)
);

-- --------------------------------------------------------

--
-- Struttura stand-in per le viste `v_c`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_c` (
...
--
-- Struttura stand-in per le viste `v_capiarea`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_capiarea` (
`lastNameC` varchar(50)
,`firstNameC` varchar(50)
,`jobTitleC` varchar(50)
,`anno` int(4)
,`mese` int(2)
,`productLine` varchar(50)
,`totalefatturato` decimal(42,2)
,`totalericavo` decimal(43,2)
,`totalepezzi` decimal(32,0)
);

-- --------------------------------------------------------

--
-- Struttura stand-in per le viste `v_commerciali`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_commerciali` (
`employeeNumber` int(11)
,`lastName` varchar(50)
,`firstName` varchar(50)
,`city` varchar(50)
...
--
-- Struttura stand-in per le viste `v_custoemrs_tipo`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_custoemrs_tipo` (
`customerNumber` int(11)
,`customerName` varchar(50)
...
,`tipoparam` varchar(45)
);

-- --------------------------------------------------------

--
-- Struttura stand-in per le viste `v_getcurrentyear`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_getcurrentyear` (
`anno` int(4)
);
...
--
-- Struttura stand-in per le viste `v_organigramma`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_organigramma` (
`employeeNumber` int(11)
,`lastName` varchar(50)
,`firstName` varchar(50)
,`jobTitle` varchar(50)
...
,`firstNameC` varchar(50)
,`jobTitleC` varchar(50)
,`lastNameCC` varchar(50)
,`firstNameCC` varchar(50)
,`jobTitleCC` varchar(50)
,`lastNameCCC` varchar(50)
,`firstNameCCC` varchar(50)
,`jobTitleCCC` varchar(50)
,`city` varchar(50)
,`country` varchar(50)
...
--
-- Struttura stand-in per le viste `v_top5`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_top5` (
`employeeNumber` int(11)
...
--
-- Struttura stand-in per le viste `v_union_best5_bestdistance`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_union_best5_bestdistance` (
`customerNumber` int(11)
,`customerName` varchar(50)
,`phone` varchar(50)
,`city` varchar(50)
...
--
-- Struttura per vista `v_all_sale`
--
DROP TABLE IF EXISTS `v_all_sale`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_all_sale`  AS  select `c`.`customerNumber` AS `customerNumber`,`c`.`salesRepEmployeeNumber` AS `salesRepEmployeeNumber`,`c`.`customerName` AS `customerName`,`o`.`orderNumber` AS `orderNumber`,`o`.`orderDate` AS `orderDate`,`p`.`productCode` AS `productCode`,`d`.`priceEach` AS `priceEach`,`d`.`quantityOrdered` AS `quantityOrdered`,`p`.`buyPrice` AS `buyPrice`,`p`.`productName` AS `productName`,`p`.`productLine` AS `productLine`,(`d`.`priceEach` * `d`.`quantityOrdered`) AS `totsale`,(`p`.`buyPrice` * `d`.`quantityOrdered`) AS `totcost`,((`d`.`priceEach` * `d`.`quantityOrdered`) - (`p`.`buyPrice` * `d`.`quantityOrdered`)) AS `totricavo` from (((`customers` `c` join `orders` `o` on((`c`.`customerNumber` = `o`.`customerNumber`))) join `orderdetails` `d` on((`d`.`orderNumber` = `o`.`orderNumber`))) join `products` `p` on((`p`.`productCode` = `d`.`productCode`))) ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_c`
--
DROP TABLE IF EXISTS `v_c`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_c`  AS  select `employees`.`employeeNumber` AS `employeeNumber`,`employees`.`lastName` AS `lastName`,`employees`.`firstName` AS `firstName`,`employees`.`extension` AS `extension`,`employees`.`email` AS `email`,`employees`.`officeCode` AS `officeCode`,`employees`.`reportsTo` AS `reportsTo`,`employees`.`jobTitle` AS `jobTitle` from `employees` ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_capiarea`
--
DROP TABLE IF EXISTS `v_capiarea`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_capiarea`  AS  select `v_organigramma`.`lastNameC` AS `lastNameC`,`v_organigramma`.`firstNameC` AS `firstNameC`,`v_organigramma`.`jobTitleC` AS `jobTitleC`,year(`v_all_sale`.`orderDate`) AS `anno`,month(`v_all_sale`.`orderDate`) AS `mese`,`v_all_sale`.`productLine` AS `productLine`,sum(`v_all_sale`.`totsale`) AS `totalefatturato`,sum(`v_all_sale`.`totricavo`) AS `totalericavo`,sum(`v_all_sale`.`quantityOrdered`) AS `totalepezzi` from (`v_all_sale` join `v_organigramma` on((`v_all_sale`.`salesRepEmployeeNumber` = `v_organigramma`.`employeeNumber`))) group by `v_organigramma`.`lastNameC`,`v_organigramma`.`firstNameC`,`v_organigramma`.`jobTitleC`,year(`v_all_sale`.`orderDate`),month(`v_all_sale`.`orderDate`),`v_all_sale`.`productLine` order by `v_organigramma`.`lastNameC`,`v_organigramma`.`firstNameC`,`v_organigramma`.`jobTitleC`,year(`v_all_sale`.`orderDate`),month(`v_all_sale`.`orderDate`),`v_all_sale`.`productLine` ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_commerciali`
--
DROP TABLE IF EXISTS `v_commerciali`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_commerciali`  AS  select `v_organigramma`.`employeeNumber` AS `employeeNumber`,`v_organigramma`.`lastName` AS `lastName`,`v_organigramma`.`firstName` AS `firstName`,`v_organigramma`.`city` AS `city`,`v_organigramma`.`country` AS `country`,`v_organigramma`.`jobTitle` AS `jobTitle`,year(`v_all_sale`.`orderDate`) AS `anno`,month(`v_all_sale`.`orderDate`) AS `mese`,`v_all_sale`.`productLine` AS `productLine`,sum(`v_all_sale`.`totsale`) AS `totalefatturato`,sum(`v_all_sale`.`totricavo`) AS `totalericavo`,sum(`v_all_sale`.`quantityOrdered`) AS `totalepezzi` from (`v_all_sale` join `v_organigramma` on((`v_all_sale`.`salesRepEmployeeNumber` = `v_organigramma`.`employeeNumber`))) group by `v_organigramma`.`employeeNumber`,`v_organigramma`.`lastName`,`v_organigramma`.`firstName`,`v_organigramma`.`city`,`v_organigramma`.`country`,`v_organigramma`.`jobTitle`,year(`v_all_sale`.`orderDate`),month(`v_all_sale`.`orderDate`),`v_all_sale`.`productLine` order by `v_organigramma`.`lastNameC`,`v_organigramma`.`firstNameC`,`v_organigramma`.`jobTitleC`,year(`v_all_sale`.`orderDate`),month(`v_all_sale`.`orderDate`),`v_all_sale`.`productLine` ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_custoemrs_tipo`
--
DROP TABLE IF EXISTS `v_custoemrs_tipo`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_custoemrs_tipo`  AS  select `customers`.`customerNumber` AS `customerNumber`,`customers`.`customerName` AS `customerName`,`customers`.`contactLastName` AS `contactLastName`,`customers`.`contactFirstName` AS `contactFirstName`,`customers`.`phone` AS `phone`,`customers`.`addressLine1` AS `addressLine1`,`customers`.`addressLine2` AS `addressLine2`,`customers`.`city` AS `city`,`customers`.`state` AS `state`,`customers`.`postalCode` AS `postalCode`,`customers`.`country` AS `country`,`customers`.`salesRepEmployeeNumber` AS `salesRepEmployeeNumber`,`customers`.`creditLimit` AS `creditLimit`,(case when (`customers`.`creditLimit` < `params`.`credit1`) then `params`.`msg1` when (`customers`.`creditLimit` < `params`.`credit2`) then `params`.`msg2` when (`customers`.`creditLimit` < `params`.`credit3`) then `params`.`msg3` else `params`.`msgover` end) AS `tipoparam` from (`customers` join `params`) ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_getcurrentyear`
--
DROP TABLE IF EXISTS `v_getcurrentyear`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_getcurrentyear`  AS  select year(`orders`.`orderDate`) AS `anno` from `orders` order by year(`orders`.`orderDate`) desc limit 1 ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_organigramma`
--
DROP TABLE IF EXISTS `v_organigramma`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_organigramma`  AS  select `e`.`employeeNumber` AS `employeeNumber`,`e`.`lastName` AS `lastName`,`e`.`firstName` AS `firstName`,`e`.`jobTitle` AS `jobTitle`,`c`.`lastName` AS `lastNameC`,`c`.`firstName` AS `firstNameC`,`c`.`jobTitle` AS `jobTitleC`,`cc`.`lastName` AS `lastNameCC`,`cc`.`firstName` AS `firstNameCC`,`cc`.`jobTitle` AS `jobTitleCC`,`ccc`.`lastName` AS `lastNameCCC`,`ccc`.`firstName` AS `firstNameCCC`,`ccc`.`jobTitle` AS `jobTitleCCC`,`o`.`city` AS `city`,`o`.`country` AS `country`,`o`.`territory` AS `territory`,`o`.`officeCode` AS `officeCode` from ((((`employees` `e` join `offices` `o` on((`o`.`officeCode` = `e`.`officeCode`))) left join `employees` `c` on((`c`.`employeeNumber` = `e`.`reportsTo`))) left join `employees` `cc` on((`cc`.`employeeNumber` = `c`.`reportsTo`))) left join `employees` `ccc` on((`ccc`.`employeeNumber` = `cc`.`reportsTo`))) order by `ccc`.`reportsTo`,`cc`.`reportsTo`,`c`.`reportsTo`,`e`.`reportsTo`,`e`.`lastName`,`e`.`firstName` ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_top5`
--
DROP TABLE IF EXISTS `v_top5`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_top5`  AS  select `v_commerciali`.`employeeNumber` AS `employeeNumber`,sum(`v_commerciali`.`totalefatturato`) AS `tot` from `v_commerciali` where `v_commerciali`.`anno` in (select `v_getcurrentyear`.`anno` from `v_getcurrentyear`) group by `v_commerciali`.`employeeNumber` order by sum(`v_commerciali`.`totalefatturato`) desc limit 5 ;

-- --------------------------------------------------------

--
-- Struttura per vista `v_union_best5_bestdistance`
--
DROP TABLE IF EXISTS `v_union_best5_bestdistance`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_union_best5_bestdistance`  AS  select `c`.`customerNumber` AS `customerNumber`,`c`.`customerName` AS `customerName`,`c`.`phone` AS `phone`,`c`.`city` AS `city`,`c`.`creditLimit` AS `creditLimit` from `customers` `c` where ((not(`c`.`country` in (select `offices`.`country` from `offices`))) and (`c`.`creditLimit` > 100000)) union select `customers`.`customerNumber` AS `customerNumber`,`customers`.`customerName` AS `customerName`,`customers`.`phone` AS `phone`,`customers`.`city` AS `city`,`customers`.`creditLimit` AS `creditLimit` from `customers` where (`customers`.`salesRepEmployeeNumber` in (select `v_top5`.`employeeNumber` from `v_top5`) and (`customers`.`creditLimit` > 100000)) ;
...
ALTER TABLE `orderdetails`
  ...
  ADD UNIQUE KEY `uq_key` (`orderNumber`,`orderLineNumber`),
...
--
-- AUTO_INCREMENT per la tabella `params`
--
ALTER TABLE `params`
  MODIFY `id_param` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
-- Procedure
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `cancellaordini` (`mindate` DATE)  BEGIN

delete  from orderdetails  where ordernumber in 
	(
		select o.orderNumber from orders o where o.orderDate < mindate
	);

delete  from orders where  orderDate < mindate;
    

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `delcustomers` (`id` INT, OUT `nr` INT)  BEGIN
delete from orderdetails where orderNumber = id ;
select row_count() into nr;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `delorderdetails` (IN `idorder` INT, OUT `nr` INT)  BEGIN
delete from orderdetails where orderNumber = idorder ;
select row_count() into nr;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllProducts` ()  BEGIN
   SELECT * ,ProductLevel(MSRP) as livello  FROM products limit 0,3000;
   END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getcustomer` (IN `nome` VARCHAR(100))  NO SQL
select * from customers where customerName like nome$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getOffices` (`codeparam` INT)  BEGIN
	select * from offices where officeCode= codeparam;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `get_union_best5_bestOutrange_By_mincredit` (`mincredit` INT)  BEGIN
SELECT 
    ...
    FROM
        `customers` `c`
    WHERE
        ((NOT (`c`.`country` IN (SELECT 
                `offices`.`country`
            FROM
                `offices`)))
            AND (`c`.`creditLimit` > mincredit)) 
    UNION SELECT 
    ...
    FROM
        `customers`
    WHERE
        (`customers`.`salesRepEmployeeNumber` IN (SELECT 
                `v_top5`.`employeeNumber`
            FROM
                `v_top5`)
            AND (`customers`.`creditLimit` > mincredit));
...
CREATE DEFINER=`root`@`localhost` FUNCTION `getTipoByCredit` (`p_creditLimit` DOUBLE) RETURNS VARCHAR(20) CHARSET latin1 BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `ProductLevel` (`p_creditLimit` DOUBLE) RETURNS VARCHAR(10) CHARSET latin1 BEGIN
    DECLARE lvl varchar(10);
     IF p_creditLimit > 180 THEN
SET lvl = 'PLATINUM';
    ELSEIF (p_creditLimit <= 180 AND p_creditLimit >= 90) THEN
        SET lvl = 'GOLD';
    ELSEIF p_creditLimit < 90 THEN
        SET lvl = 'SILVER';
    END IF;
RETURN (lvl);
END$$
...
-- Eventi
--
CREATE DEFINER=`root`@`localhost` EVENT `test_event_02` ON SCHEDULE AT '2020-02-17 18:25:54' ON COMPLETION PRESERVE DISABLE DO INSERT INTO messages(message,created_at)
